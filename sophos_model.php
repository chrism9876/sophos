...
class Sophos_model extends \Model
{
    ...
    {
        $sql = "SELECT COUNT(CASE WHEN installed = 'Sophos Business' THEN 1 END) AS 'business', COUNT(CASE WHEN installed = 'Sophos Central' OR installed = 'Sophos Central with InterceptX' THEN 1 END) AS 'central', COUNT(CASE WHEN installed = 'Not Installed' THEN 1 END) AS 'notinstalled'
            FROM sophos
